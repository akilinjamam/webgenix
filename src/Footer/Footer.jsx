    ...
    return (
        <div className={footer.main}>
            <div className={footer.partOne}>
                ...
                <img style={{width:'90%'}} src={humanTable} alt="" />
                </div>
            </div>
            <div className={footer.partTwo}>
                <div className={footer.twoLeft}>
                    <div className={footer.twoLeftContainer}>
                        <img style={{width:'80%', marginBottom:'5px', margin:'auto', display:'block'}} src={logo} alt="" />
                        ...
                        <p style={{marginTop:'0px',marginBottom:'0px', padding:'0', textAlign:'center', color:'black', fontSize:'10px', fontWeight:'bold'}}> Your One-stop Web Solution</p>
                        <div style={{width:'80%', margin:'auto'}}>
                            {
                                footerIcons.map(data => {
                                    return (
                                        <p style={{display:'flex', alignItems:'center'}} key={data.id}>
                                            <span><img style={{width:'20px', marginRight:'5px'}} src={data.icon} alt="" /></span>
